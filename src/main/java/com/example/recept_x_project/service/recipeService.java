...
public class recipeService {
   ...
   public static List<Recipe> Recipes =List.of(
    ...
    new Recipe("EGYSZERŰ BANÁNOS MUFFIN", NAGYON_NEHÉZ, 45, false,true,false,"\n2db banán \n15dkg liszt \n1csom sütőpor \n10dkg cukor \n1csom vaníliás cukor \n1db tojás \n0.8dl olaj \nvaj \nbanánkarikák","A meghámozott banánokat összetörjük egy villával.\n" +
